...
async function populateUI(songinfo) {
    if (songinfo) {
        ...
        document.getElementById("song").innerText = " " + songinfo.name;
        console.log(songinfo.name);
        document.getElementById("album").innerText = " " + songinfo.album.name;
        console.log(songinfo.album.name);
        document.getElementById("artist").innerText = " " + songinfo.artists[0].name;
